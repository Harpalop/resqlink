...
const FOOTER_COLUMNS = [
  {
    title: 'Platform',
    links: ['Smart SOS', 'Medical ID', 'Blood Network', 'Telemedicine', 'Family Safety'],
  },
  {
    title: 'Resources',
    links: ['First Aid Center', 'Disaster Alerts', 'LoRa Hardware', 'Developer Docs'],
  },
  {
    title: 'Company',
    links: ['About', 'Community', 'Contact', 'Privacy'],
  },
]
    ...
    <footer className="relative border-t border-border">
      <div className="mx-auto max-w-7xl px-5 py-14 md:px-8">
        <div className="grid gap-10 md:grid-cols-[1.4fr_1fr_1fr_1fr]">
          <div className="space-y-4">
            ...
            <p className="max-w-xs text-sm leading-relaxed text-muted-foreground">
              Connecting Lives During Emergencies. A smart emergency response ecosystem for
          ...
          {FOOTER_COLUMNS.map((column) => (
            <div key={column.title}>
              <h3 className="mb-4 text-sm font-semibold tracking-wide">{column.title}</h3>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-border pt-6 text-sm text-muted-foreground md:flex-row">
          <p>© 2026 ResQLink. Built to save lives.</p>
